...
const messages = {
  en: {
    ...
    contactSubmitStatus: "Thank you. Your enquiry has been sent.",
    contactSubmitError: "We could not send your enquiry. Please try again later.",
  ...
  de: {
    ...
    contactSubmitStatus: "Vielen Dank. Ihre Anfrage wurde gesendet.",
    contactSubmitError: "Ihre Anfrage konnte nicht gesendet werden. Bitte versuchen Sie es später erneut.",
    contactEyebrow: "Support",
